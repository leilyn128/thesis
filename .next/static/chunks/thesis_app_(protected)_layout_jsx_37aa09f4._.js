...
function ProtectedLayout(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProtectedLayout.useEffect": ()=>{
            let isMounted = true;
            const checkSession = {
                "ProtectedLayout.useEffect.checkSession": async ()=>{
            ...
            }["ProtectedLayout.useEffect.checkSession"];
            checkSession();
            ...
            const { data: listener } = __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "ProtectedLayout.useEffect": (_event, session)=>{
                    if (!session) {
                        router.replace("/auth");
                    } else {
                        setUser(session.user);
    ...
    // ✅ Show loading screen only once (not on every route change)
    if (loading) {
...
_s(ProtectedLayout, "JshmIRYzPWPRasLYLhU9bYsAiI4=", false, function() {
    return [
