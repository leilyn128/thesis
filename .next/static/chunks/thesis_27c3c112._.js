...
function LoginPage() {
    ...
    const [isSignup, setIsSignup] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false) // 🔥 toggle between login/signup
    ;
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (isSignup) {
                ...
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                    email,
                    password
                });
                data = result.data;
                ...
                // 🔑 Login with Supabase
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                    email,
                    password
                });
                data = result.data;
...
//# sourceMappingURL=thesis_27c3c112._.js.map