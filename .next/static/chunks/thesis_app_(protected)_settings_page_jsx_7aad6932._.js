...
function AccountSettingsPage() {
    ...
    const handleChangePassword = async (e)=>{
        ...
        try {
            ...
            const response = await fetch("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL, "/api/accounts/change-password/"), {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
                ...
                setMessage("❌ ".concat(data.error || "Something went wrong"));
            }
        } catch (err) {
...
_s(AccountSettingsPage, "RfL5mZaFKl6m8A8sfbodJoVsoUg=");
