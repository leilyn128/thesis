...
function DashboardPage() {
    const [iraData, setIraData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    async function fetchIRA() {
        setLoading(true);
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("trial_balance").select("account_name, debit, credit, year");
            if (error) throw error;
            // 🧩 Define possible IRA/NTA account name keywords
            const iraKeywords = [
            ...
            // 🧠 Filter IRA/NTA entries based on keywords
            const iraEntries = data.filter((row)=>iraKeywords.some((keyword)=>row.account_name?.toLowerCase().includes(keyword)));
            // 🧾 Sum total IRA by year
            const yearlyTotals = {};
            ...
            // ✅ Sort years numerically (so 2024 won’t be skipped)
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Historical trend and yearly growth based on “Share from Internal Revenue Collections”"
                    }, void 0, false, {
                        fileName: "[project]/thesis/app/(protected)/dashboard/page.jsx",
                        lineNumber: 83,
                        columnNumber: 9
